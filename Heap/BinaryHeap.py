...
def heapifyInsertTree(rootNode,index,heapType):
    ...
    if heapType == "Min":
        ...
        heapifyInsertTree(rootNode,parentIndex,heapType)
    elif heapType == "Max":
        if rootNode.customList[index] > rootNode.customList[parentIndex]:
            temp = rootNode.customList[index]
            rootNode.customList[index] = rootNode.customList[parentIndex]
...
def insertNode(rootNode,nodeValue,heapType):
    ...
    rootNode.heapSize += 1
    heapifyInsertTree(rootNode,rootNode.heapSize,heapType)
...
# insertNode(newBinaryHeap,3,"Min")
# insertNode(newBinaryHeap,17,"Min")
# insertNode(newBinaryHeap,9,"Min")
# insertNode(newBinaryHeap,10,"Min")
# insertNode(newBinaryHeap,19,"Min")
# insertNode(newBinaryHeap,12,"Min")
# insertNode(newBinaryHeap,11,"Min")
# print(levelOrderTraversal(newBinaryHeap))
